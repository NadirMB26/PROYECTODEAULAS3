...
private Role rolActual;
    ...
    private void ButtonSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonSaveActionPerformed
       if(FieldName.getText().isEmpty()&&boxDescription.getText().isEmpty()){
    ...
    private void ButtonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonEliminarActionPerformed
     try {
           ...
           // int eli=rolActual.getId();
            var rolRepository=new RoleRepository();  
            var eliminarRolCommand=new EliminarRolCommandHandler(rolRepository);
           eliminarRolCommand.eliminar(rolActual);
